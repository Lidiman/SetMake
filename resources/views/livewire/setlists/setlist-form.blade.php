        ...
        <div class="xl:col-span-2 space-y-6">
            ...
            <div class="card relative overflow-visible z-20">
                ...
                <div class="relative">
                    ...
                    <input wire:model.live.debounce.300ms="searchQuery" type="text" class="input pl-10 bg-surface-950 border-surface-700" placeholder="Search library to add songs...">
                                ...
                                @foreach($searchResults as $song)
                                    <li>
                                        <button type="button" wire:click="addSong({{ $song->id }})" class="w-full text-left px-4 py-3 hover:bg-surface-700 flex items-center justify-between group transition-colors border-b border-surface-700/50 last:border-0">
                                            <div>
                                                <p class="font-medium text-white group-hover:text-primary-400">{{ $song->title }}</p>
